...
{
    int opt = TRUE;
    int master_socket , addrlen , new_socket , client_socket[INITIAL_MAX_CLIENTS] , max_clients = INITIAL_MAX_CLIENTS , activity, i , valread , sd;
    int max_sd;
    ...
    selector_register(selector, master_socket, &(fd_handler){
        .handle_read = NULL, // Define your read handler here
        .handle_write = NULL, // Define your write handler here
